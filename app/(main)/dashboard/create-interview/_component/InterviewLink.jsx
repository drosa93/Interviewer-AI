...
// Button to copy the link to clipboard
  ...
  return (
    <div className="flex flex-col items-center justify-center mt-10">
      ...
      <p className="mt-3">
        share this link with your condidates to start the interview process
      </p>
      <div className="w-full p-7 mt-6 rounded-lg bg-white">
        ...
        <div className="flex gap-5">
            ...
            <h2 className="text-xs text-gray-500 flex-gap-2 items-center"><List className="h-4 w-4"/>10 questions</h2>
        </div>
      </div>
